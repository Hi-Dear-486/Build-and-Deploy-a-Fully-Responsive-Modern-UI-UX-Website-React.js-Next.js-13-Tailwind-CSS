    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <Image
          ...
          width={50}
          height={50}
          className="absolute left-[-5px] top-[-30px]  w-auto h-auto lg:w-[50px]"
        />
      ...
      <div className="relative flex flex-1 items-start mx-auto -top-10 lg:-left-14">
        <div className="relative   z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-4 py-6">
